...
const FileTreeNode: React.FC<FileTreeNodeProps> = ({ node, level = 0, expandedPaths, onToggleExpand }) => {
...
export const WorkingDirectoryBrowser = forwardRef<WorkingDirectoryBrowserRef>((props, ref) => {
