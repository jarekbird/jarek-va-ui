# TASK-6: In the Python `cursor-executor` backend, locate all API endpoints related to conversations and tasks (lists and details).
...
All changes for this task must be made in the `cursor-executor-back` application located at `python-cursor/cursor-executor/cursor-executor-back/`. This task involves working with the Python backend code to locate and document API endpoints. Do not make changes in the `jarek-va-ui` application.

## Current State

- Previous tasks (1-5) have been completed
...
- [ ] Understand dependencies and prerequisites (tasks 1-5 should be completed)
...
- [ ] Step 1: Locate Python cursor-executor backend
  - [ ] Navigate to `python-cursor/cursor-executor/cursor-executor-back/` directory
  - [ ] Identify the API server file (likely FastAPI or Flask app)
  - [ ] Locate route definitions for conversations and tasks
- [ ] Step 2: Document conversation endpoints
  - [ ] Find GET endpoint for conversation list (e.g., `/api/conversations` or `/conversations/api/list`)
  - [ ] Find GET endpoint for conversation details (e.g., `/api/conversations/:id`)
  - [ ] Document HTTP methods, paths, and any query parameters
- [ ] Step 3: Document task endpoints
  - [ ] Find GET endpoint for task list (e.g., `/api/tasks`)
  - [ ] Find GET endpoint for task details (e.g., `/api/tasks/:id`)
  - [ ] Document HTTP methods, paths, and any query parameters
- [ ] Step 4: Test endpoints manually or with curl
  - [ ] Make test requests to each endpoint
  - [ ] Capture example responses for documentation
  - [ ] Note any authentication requirements

### Specific Requirements

- [ ] API functions must handle errors gracefully
- [ ] API functions must transform backend data to frontend types
- [ ] API functions should include proper TypeScript types
- [ ] API functions should be testable with mocks
...
- **Execution Timing**: This task should be executed after completing tasks 1-5
- **Dependencies**: 
  - Tasks 3, 4, 5 must be completed first
...
5. **Git Commit and Push**
   ...
   - Commit message follows project conventions: `TASK-6: In the Python `cursor-executor` backend, locate all API endpoints related to conversations and tasks (lists and details).`
