# TASK-31: Wire the layout into the routing configuration so that all main routes render inside the layout.

**Section**: 7. Routing & Layout Shell
**Subsection**: 7.X
**Task ID**: TASK-31
...
- Previous tasks (1-30) have been completed
...
- [ ] Understand dependencies and prerequisites (tasks 1-30 should be completed)
...
- This task is part of Section 7: Routing & Layout Shell
- **Execution Timing**: This task should be executed after completing tasks 1-30
- **Dependencies**: 
  - Tasks 28, 29, 30 must be completed first
...
- Next: TASK-32
- Dependencies:
  - Tasks 1-30 must be completed first
- Related:
  - All tasks in Section 7: Routing & Layout Shell
...
5. **Git Commit and Push**
   ...
   - Commit message follows project conventions: `TASK-31: Wire the layout into the routing configuration so that all main routes render inside the layout.`
