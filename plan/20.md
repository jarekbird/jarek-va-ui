# TASK-20: Add a `src/query/queryClient.ts` file that exports a configured `QueryClient` with sensible defaults (retry policy, `staleTime`, `cacheTime`).

**Section**: 5. TanStack Query Setup
**Subsection**: 5.X
**Task ID**: TASK-20
...
- Previous tasks (1-19) have been completed
...
- [ ] Understand dependencies and prerequisites (tasks 1-19 should be completed)
...
- This task is part of Section 5: TanStack Query Setup
- **Execution Timing**: This task should be executed after completing tasks 1-19
- **Dependencies**: 
  - Tasks 17, 18, 19 must be completed first
...
- Next: TASK-21
- Dependencies:
  - Tasks 1-19 must be completed first
- Related:
  - All tasks in Section 5: TanStack Query Setup

## Definition of Done

This task is a **CONFIGURATION TASKS** task.
...
5. **Git Commit and Push**
   ...
   - Commit message follows project conventions: `TASK-20: Add a `src/query/queryClient.ts` file that exports a configured `QueryClient` with sensible defaults (retry policy, `staleTime`, `cacheTime`).`
