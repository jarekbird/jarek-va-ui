# TASK-13: Create `src/api/client.ts` that exports a configured HTTP client (e.g., `fetch` wrapper or Axios instance) with:

**Section**: 3. API Client Layer
**Subsection**: 3.X
**Task ID**: TASK-13
...
- Previous tasks (1-12) have been completed
...
- [ ] Understand dependencies and prerequisites (tasks 1-12 should be completed)
...
- This task is part of Section 3: API Client Layer
- **Execution Timing**: This task should be executed after completing tasks 1-12
- **Dependencies**: 
  - Tasks 10, 11, 12 must be completed first
...
- Next: TASK-14
- Dependencies:
  - Tasks 1-12 must be completed first
- Related:
  - All tasks in Section 3: API Client Layer
...
5. **Git Commit and Push**
   ...
   - Commit message follows project conventions: `TASK-13: Create `src/api/client.ts` that exports a configured HTTP client (e.g., `fetch` wrapper or Axios instance) with:`
