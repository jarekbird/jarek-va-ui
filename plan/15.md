# TASK-15: Add environment configuration handling for base URL (e.g., from `process.env` or `import.meta.env`) and test that configuration logic.
...
- Previous tasks (1-14) have been completed
...
- [ ] Understand dependencies and prerequisites (tasks 1-14 should be completed)
...
- **Execution Timing**: This task should be executed after completing tasks 1-14
- **Dependencies**: 
  - Tasks 12, 13, 14 must be completed first
...
- Next: TASK-16
- Dependencies:
  - Tasks 1-14 must be completed first
- Related:
...
5. **Git Commit and Push**
   ...
   - Commit message follows project conventions: `TASK-15: Add environment configuration handling for base URL (e.g., from `process.env` or `import.meta.env`) and test that configuration logic.`
